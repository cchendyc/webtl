...
let practice12 = [
    ['孫がいない婆さんが帰り道の小学生に飴をあげた。', ['母', '息子', 'ご飯']],
    ['彼女に振られた私が励みをとなりに座っている人にもらった。', ['田中さん', '泥棒', '財布']],
    ['食べ物が好きだと言った私に人に優しい友達がおみやげをくれた。', ['山田さん', '友達', 'お金']],
    ['博物館の壁に絵を嬉しそうなあの人がかけた。', ['中村くん', '彼女', 'プレゼント']],
    ['部屋の窓を臆病な私が顔が覆われている泥棒に割られた。', ['高橋さん', '同僚', 'チョコレート']],
    ['酒を成人年齢になっていない娘に子どもを甘やかす親が飲ませなかった。', ['兄さん', '私', 'ケーキ']],
]
...
let normal12 = [
    ...
    ['お客さんに怒られた新入社員に励ましカードを気遣いができる二宮があげた。', ['お客さん', '新入社員', '気遣い', '二宮']],
...
let rubyNormal12 = [
    ...
    "おきゃくさんにおこられたしんにゅうしゃいんにはげましカードをきづかいができるにのみやがあげた。",
    ...
    "はなをおやにあまやかされるいもうとにいもうとがすきなあねがあげた。",
